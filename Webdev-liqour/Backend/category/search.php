    ...
    if ($res && $res->num_rows > 0) {
        while ($row = $res->fetch_assoc()) {
            ...
            echo "<tr>
                    ...
                    <td>
                        <a href='update-category.php?id={$id}' class='btn'>Update</a>
                        <a href='delete-category.php?id={$id}&type=soft' onclick=\"return confirm('Soft delete this category?');\" class='btn soft-delete'>Soft Delete</a>
                        <a href='delete-category.php?id={$id}&type=hard' onclick=\"return confirm('Permanently delete this category?');\" class='btn delete'>Delete Forever</a>
                    </td>
                  </tr>";
        }
    } else {
