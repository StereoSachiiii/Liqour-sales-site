    ...
    if ($res && $res->num_rows > 0) {
        while ($row = $res->fetch_assoc()) {
            ...
            echo "<tr>
                    ...
                    <td>{$created}</td>
                    <td>
                        <a href='delete.php?id={$id}&type=soft' onclick=\"return confirm('Soft delete this review?');\" class='btn soft-delete'>Soft Delete</a>
                        <a href='delete.php?id={$id}&type=hard' onclick=\"return confirm('Permanently delete this review?');\" class='btn delete'>Delete Forever</a>
                    </td>
                  </tr>";
        }
    } else {
